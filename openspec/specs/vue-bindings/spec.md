...
Optional Vue 3 component for the flowchart editor, shipped at `@vanduo-oss/flowchart/vue`. The core package stays framework-agnostic; these bindings are additive.
